...
fun BottomNavigationBar(navController: NavController) {
    ...
    visible = (navBackStackEntry?.destination?.route == NavigationItems.Home.route
            || navBackStackEntry?.destination?.route == NavigationItems.Movies.route
            || navBackStackEntry?.destination?.route == NavigationItems.Books.Overview.route)
        ...
        BottomNavigation(
            ...
            bottomTabList.forEach { tab ->
                BottomNavigationItem(
                    icon = {
                        Icon(
                            painterResource(id = tab.page_icon),
